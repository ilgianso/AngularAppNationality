...
let CountryService = class CountryService {
    ...
    getPopulatedCountries() {
        return _country_data__WEBPACK_IMPORTED_MODULE_2__["COUNTRIES"].sort((a, b) => b.population - a.population).slice(0, 3);
    }
    getLargestCountries() {
        return _country_data__WEBPACK_IMPORTED_MODULE_2__["COUNTRIES"].sort((a, b) => b.area - a.area).slice(0, 3);
    }
    getGDPCountries() {
        return _country_data__WEBPACK_IMPORTED_MODULE_2__["COUNTRIES"].sort((a, b) => b.gdp - a.gdp).slice(0, 3);
    }
    getCountry(name) {
        return _country_data__WEBPACK_IMPORTED_MODULE_2__["COUNTRIES"].find(Country => Country.name === name);
    }
};
